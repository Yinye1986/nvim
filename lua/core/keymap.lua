...
vim.keymap.set("n", "<C-n>", "<C-Left>", { noremap = true, silent = true })
vim.keymap.set("n", "<C-i>", "<C-Right>", { noremap = true, silent = true })
vim.keymap.set("n", "N", "ge", { noremap = true, silent = true })
vim.keymap.set("n", "I", "w", { noremap = true, silent = true })
vim.keymap.set("v", "<C-n>", "ge", { noremap = true, silent = true })
vim.keymap.set("v", "<C-i>", "w", { noremap = true, silent = true })
---
...
vim.keymap.set("i", '<A-u>', '<Up>', { noremap = true, silent = true })
vim.keymap.set("i", '<A-e>', '<Down>', { noremap = true, silent = true })
vim.keymap.set("i", '<A-n>', '<Left>', { noremap = true, silent = true })
vim.keymap.set("i", '<A-i>', '<Right>', { noremap = true, silent = true })
---
...
vim.keymap.set("v", "E", ":m '>+1<CR>gv=gv", { noremap = true, silent = true })
vim.keymap.set("v", "N", "<gv", { noremap = true, silent = true })
...
---
vim.keymap.set({ "n", "v" }, "<A-n>", ":-tabmove<CR>", { noremap = true, silent = true }) -- Alt+n/i左右切换标签页
vim.keymap.set({ "n", "v" }, "<A-i>", ":+tabmove<CR>", { noremap = true, silent = true })
---
vim.keymap.set({ "n", "v" }, "<A-Up>", "<C-w>k", { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<A-Down>", "<C-w>j", { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<A-Left>", '<C-w>h', { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<A-Right>", '<C-w>l', { noremap = true, silent = true })
--- 模式切换 ---
vim.keymap.set({ "n", "v", "i" }, '<C-o>', '<Esc>', { noremap = true, silent = true })
---
...
vim.keymap.set({ "n", "v", "i" }, "<tab>", "<tab>", { noremap = true, silent = true })
