...
-- 光标移动
keymap.set({ "n", "v" }, "u", "k", { noremap = true, silent = true }) -- nv多行多格
...
-- 跳转
-- keymap.set({ "n", "v" }, "w", print(v:count1), { noremap = true, silent = false }) -- 跳行
-- keymap.set({ "n", "v" }, "<expr>6j", "\"\" . v:count1 . \"j\"", { noremap = true, silent = false })
